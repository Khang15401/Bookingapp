...
const DetailReview = ({}) => {
  ...
  const handleClick = async (e) => {
    ...
    try {
      ...
      await axios.patch("/services/", updateService);
  ...
  return (
    ...
    //               1 đêm ·
    //               <span className="c-review-block__date">tháng 3/2023</span>
    //             </div>
    //           </li>
    //         </ul>
    ...
    //                 <div className="bui-review-score__badge">{data.rating}</div>
    //               </div>
    //             </div>
    //           </div>
    //         </div>
    ...
    //                 </span>
    //                 <span> · </span>
    //                 <span className="c-review__body">{data.positive}</span>
    //               </p>
    //             </div>
    //             <div className="c-review__row">
    //               {data.negative && (
    ...
    //                   </span>
    //                   <span> · </span>
    //                   <span className="c-review__body">{data.negative}</span>
    //                 </p>
    //               )}
    //             </div>
    //           </div>
          ...
          <div className="right">
            ...
            {/* <form>
              <div className="formInput">
                ...
                />
                <label>Khách sạn đánh giá</label>
                <input
                  // type={input.type}
